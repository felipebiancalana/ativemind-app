...
export default function DashboardPage() {
  ...
  const frases = [
    ...
    "Construa hoje o futuro que você deseja",
    "Você só precisa dar o próximo passo",
    "Cuidar do corpo transforma a mente",
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 py-8">
        {/* Logo e Frase Motivacional */}
        <div className="w-full flex flex-col items-center mt-6 mb-8">
          <Image
            src="https://m3hb2lbqjxoqzxfl.public.blob.vercel-storage.com/ChatGPT%20Image%202_12_2025%2C%2000_16_53.png"
            alt="AtiveMind Logo"
            width={140}
            height={140}
            priority
          ...
          {/* Frase motivacional gerada só no cliente */}
          {frase && (
            <p className="text-lg text-[#1A1A1A] mt-4 font-medium text-center">
              {frase}
            </p>
          )}
        </div>
